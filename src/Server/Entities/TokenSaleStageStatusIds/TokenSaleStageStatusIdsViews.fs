...
module Views =
  let index (ctx : HttpContext) (objs : TokenSaleStageStatusId list) =
    let cnt = [
      div [_class "container "] [
        h2 [ _class "title"] [rawText "Listing TokenSaleStageStatusIds"]
        ...
        a [_class "button is-text"; _href (Links.add ctx )] [rawText "New TokenSaleStageStatusId"]
      ]
    ]
    App.layout ([section [_class "section"] cnt])


  let show (ctx : HttpContext) (o : TokenSaleStageStatusId) =
    let cnt = [
      div [_class "container "] [
        h2 [ _class "title"] [rawText "Show TokenSaleStageStatusId"]
  ...
  let private form (ctx: HttpContext) (o: TokenSaleStageStatusId option) (validationResult : Map<string, string>) isUpdate =
  ...
  let add (ctx: HttpContext) (o: TokenSaleStageStatusId option) (validationResult : Map<string, string>)=
    form ctx o validationResult false

  let edit (ctx: HttpContext) (o: TokenSaleStageStatusId) (validationResult : Map<string, string>) =
